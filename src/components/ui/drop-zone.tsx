...
const dropZoneStyles = tv({
  extend: focusStyles,
  base: 'group has-[slot=description]:text-center flex max-h-[200px] max-w-xl flex-col items-center justify-center gap-2 rounded-md border border-dashed text-sm',
  variants: {
    isDropTarget: {
