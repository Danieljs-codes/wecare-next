 ...
 * @param providedSalt - Optional salt to use for hashing.
 ...
 * @returns A promise that resolves to a boolean indicating if the password attempt matches the stored hash.
 */
